 ...
 */
! function(a) {
    "function" == typeof define && define.amd ? define(["jquery", "moment"], a) : "object" == typeof exports ? // Node/CommonJS
        module.exports = a(require("jquery"), require("moment")) : a(jQuery, moment)
}(function(a, b) {
    ...
    function d(b) {
        ...
        return a.each(b, function(b, e) {
            "views" != b && (
                ...
                a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Va) ? (c = null, a.each(e, function(a, e) {
        ...
        j(b), // give all elements their natural height
            ...
            b.each(function(c, d) {
                var j = c === b.length - 1 ? f : e,
                    l = a(d).outerHeight(!0);
                j > l ? (g.push(d), h.push(l), i.push(a(d).height())) :
    ...
    function r() { // responsible for caching the computation
        return null === Wa && (Wa = s()), Wa
    }

    function s() { // creates an offscreen test element, then removes it
    ...
    function M(a, b) {
        var c, d, e;
        for (c = 0; c < Ya.length && (d = Ya[c], e = N(d, a, b), !(e >= 1 && fa(e))); c++);
        return d
    }
    ...
    function O(a, b, c) {
        var d;
        return R(c) ? (b - a) / c : (d = c.asMonths(), Math.abs(d) >= 1 && fa(d) ? b.diff(a, "months", !0) / d : b.diff(a, "days", !0) / c.asDays())
    }
    // Intelligently divides one duration by another
    function P(a, b) {
        var c, d;
        return R(a) || R(b) ? a / b : (c = a.asMonths(), d = b.asMonths(), Math.abs(c) >= 1 && fa(c) && Math.abs(d) >= 1 && fa(d) ? c / d : a.asDays() / b.asDays())
    }
    // Intelligently multiplies a duration by a number
    function Q(a, c) {
        var d;
        return R(a) ? b.duration(a * c) : (d = a.asMonths(), Math.abs(d) >= 1 && fa(d) ? b.duration({
            months: d * c
        }) : b.duration({
            days: a.asDays() * c
        }))
    ...
    function U(a, b) {
        ...
        for (c = a.length - 1; c >= 0; c--) {
            h = a[c];
            for (d in h) d in i || ( // if already assigned by previous props or complex props, don't reassign
                i[d] = h[d])
        }
        return i
    }
    ...
    function qa(a, b, c, d, e) {
        ...
        return a = Ta.moment.parseZone(a), b = Ta.moment.parseZone(b), f = (a.localeData || a.lang).call(a), c = f.longDateFormat(c) || c, d = d || " - ", ra(a, b, ta(c), d, e)
    } // expose
    ...
    function ua(a) {
        for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; b = d.exec(a);) b[1] ? // a literal string inside [ ... ]
    ...
    function wa(a, b) {
        ...
        return Y(b, "constructor") && (c = b.constructor), "function" != typeof c && (c = b.constructor = function() {
            a.apply(this, arguments)
        }), c.prototype = V(a.prototype), W(b, c.prototype), X(b, c.prototype), W(a, c), c
    }
    ...
    function Fa(c) {
        var d, e, f, g, h = Ta.dataAttrPrefix;
    ...
    function Ja(a) {
        ...
        for (b = 0; b < a.length; b++)
            for (c = a[b], d = 0; d < c.length; d++)
                for (e = c[d], e.forwardSegs = [], f = b + 1; f < a.length; f++) La(e, a[f], e.forwardSegs)
    }
    ...
    function Ka(a) {
        var b, c, d = a.forwardSegs,
            e = 0;
        if (void 0 === a.forwardPressure) { // not already computed
            for (b = 0; b < d.length; b++) c = d[b], Ka(c), e = Math.max(e, 1 + c.forwardPressure);
            a.forwardPressure = e
        }
    }
    ...
    function Na(c, d) {
        ...
        function j(a) { // isResize=true. will poll getSuggestedViewHeight() and isHeightAuto()
        ...
        function l() { // assumes elementVisible
            X = "number" == typeof O.contentHeight ? O.contentHeight : "number" == typeof O.height ? O.height - (S ? S.outerHeight(!0) : 0) : Math.round(T.width() / Math.max(O.aspectRatio, .5))
        }
        ...
        function o() { // destroys old events if previously rendered
        ...
        function v() {
            var a = N.getNow();
            a.isWithin(W.intervalStart, W.intervalEnd) ? R.disableButton("today") : R.enableButton("today")
        }
        /* Selection
         -----------------------------------------------------------------------------*/
        ...
        function x() { // safe to be called before renderView
            W && W.unselect()
        }
        /* Date
         -----------------------------------------------------------------------------*/
        ...
        function M(a, b) { // overrides the Emitter's trigger method :(
        ...
        P._fullCalendar_weekCalc = function(a) {
            ...
            // -----------------------------------------------------------------------------------
            Ra.call(N, O);
        var R, S, T, U, W, X, Y, Z, $ = N.isFetchNeeded,
            _ = N.fetchEvents,
            aa = c[0],
            ba = {},
            ca = 0,
    ...
    function Ra(c) {
        ...
        function f(b, c) {
            g(b, function(d) {
                ...
                if (c == Q) {
                    if (d)
                        for (e = 0; e < d.length; e++) f = d[e], g = h ? f : s(f, b), g && S.push.apply(S, w(g));
                    R--, R || N(S)
                }
            })
        }
        ...
        function g(b, d) {
            var e, f, h = Ta.sourceFetchers;
            for (e = 0; e < h.length; e++) {
                if (f = h[e].call(H, // this, the Calendar object
            ...
            var i = b.events;
            if (i) a.isFunction(i) ? (H.pushLoading(), i.call(H, // this, the Calendar object
                I.clone(), M.clone(), c.timezone,
                function(a) {
                    d(a), H.popLoading()
                })) : a.isArray(i) ? d(i) : d();
            else {
                ...
                if (j) {
                    ...
                    p && (o[p] = I.format()), q && (o[q] = M.format()), c.timezone && "local" != c.timezone && (o[r] = c.timezone), H.pushLoading(), a.ajax(a.extend({}, Ab, b, {
                        data: o,
                        success: function(b) {
                            b = b || [];
        ...
        function i(b) { // will return undefined if invalid source
            var c, d, e = Ta.sourceNormalizers;
        ...
        function l(a) { // a normalized event source?
            // get the primitive
        ...
        function n(b) {
            var c = {};
            return a.each(b, function(a, b) {
                o(a) && void 0 !== b && Z(b) && ( // a defined non-object
                    c[a] = b)
            }), c
        }
        ...
        function r(b) { // not null, not undefined. an event ID
        ...
        function s(d, e) {
            var f, g, h, i = {};
            if (c.eventDataTransform && (d = c.eventDataTransform(d)), e && e.eventDataTransform && (d = e.eventDataTransform(d)),
            ...
            // the event is "abstract" (recurring) so don't calculate exact start/end dates just yet
                ...
                g && (g = H.moment(g), g.isValid() || (g = null)), h = d.allDay, void 0 === h && ( // still undefined? fallback to default
                    h = _(e ? e.allDayDefault : void 0, c.allDayDefault)), t(f, g, h, i)
            }
            return i
        }
        ...
        function v(a) {
            null == a.allDay && (a.allDay = !(a.start.hasTime() || a.end && a.end.hasTime())), a.allDay ? (a.start.stripTime(), a.end &&
        ...
        function w(b, c, d) {
            ...
            if (c = c || I, d = d || M, b)
                if (b._recurring) {
                    ...
                    if (f = b.dow)
                        for (e = {}, g = 0; g < f.length; g++) e[f[g]] = !0; // holds the date of the current day
                    for (
                        // iterate through every day in the current range
                        h = c.clone().stripTime(); h.isBefore(d);) e && !e[h.day()] || (i = b.start, j = b.end, k = h.clone(), l = null, i && (k = k.time(i)), j && (l = h.clone().time(j)), m = a.extend({}, b), t(k, l, !i && !j, m), n.push(m)), h.add(1, "days")
                } else n.push(b);
            return n
        }
        ...
        function y(b, c, d, e, f, g) {
            ...
            return e && !e.valueOf() && (e = null), f && !f.valueOf() && (f = null), a.each(b, function(b, j) {
                ...
                k = {
                    ...
                    allDay: d
                }, u(l), c ? l.end = null : f && !l.end && (l.end = H.getDefaultEventEnd(l.allDay, l.start)), e && (l.start.add(e), l.end && l.end.add(e)), f && l.end.add(f), h && !l.allDay && (e || f) && (l.start.stripZone(), l.end && l.end.stripZone()), a.extend(j, g, l), Sa(j), i.push(function() {
                    a.extend(j, k), Sa(j)
                })
            }),
                function() {
        ...
        function D(a, b, c, d) {
            ...
            for (g = H.getPeerEvents(a, d), h = 0; h < g.length; h++)
                ...
                if (i = g[h], G(i, a)) {
                    ...
                    if (d) {
                        if (j = _(i.overlap, (i.source || {}).overlap), j === !1) return !1;
        ...
        a.each((c.events ? [c.events] : []).concat(c.eventSources || []), function(a, b) {
            ...
            /* Business Hours
             -----------------------------------------------------------------------------------------*/
            H.getBusinessHoursEvents = z,
            /* Overlapping / Constraining
             -----------------------------------------------------------------------------------------*/
            H.isEventSpanAllowed = A, H.isExternalSpanAllowed = B, H.isSelectionSpanAllowed = C, H.getEventCache = function() {
            return S
        }
    }
    ...
    var Ta = a.fullCalendar = {
            version: "2.7.1",
            internalApiVersion: 3
        },
        Ua = Ta.views = {};
    Ta.isTouch = "ontouchstart" in document, a.fn.fullCalendar = function(b) {
        ...
        return this.each(function(e, f) { // loop each DOM element involved
            ...
            // a method call
            "string" == typeof b ? i && a.isFunction(i[b]) && (g = i[b].apply(i, c), e || (d = g), "destroy" === b && h.removeData("fullCalendar")) : i || (i = new vb(h, b), h.data("fullCalendar", i), i.render())
        }), d
    };
    var Va = [ // names of options that are objects whose properties should be combined
        "header", "buttonText", "buttonIcons", "themeButtonIcons"
    ];
    // exports
    Ta.intersectRanges = I, Ta.applyAll = $, Ta.debounce = ha, Ta.isInt = fa, Ta.htmlEscape = aa, Ta.cssToStr = ca, Ta.proxy = ga, Ta.capitaliseFirstLetter = da,
    ...
    Ta.preventDefault = z,
        ...
        /* Object Ordering by Field
         ----------------------------------------------------------------------------------------------------------------------*/
        Ta.parseFieldSpecs = E, Ta.compareByFieldSpecs = F, Ta.compareByFieldSpec = G, Ta.flexibleCompare = H,
        /* Date Utilities
         ----------------------------------------------------------------------------------------------------------------------*/
        Ta.computeIntervalUnit = M, Ta.divideRangeByDuration = O, Ta.divideDurationByDuration = P, Ta.multiplyDuration = Q, Ta.durationHasTime = R;
    var Xa = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        Ya = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    /* Logging and Debug
     ----------------------------------------------------------------------------------------------------------------------*/
    Ta.log = function() {
        ...
        var a = window.console;
        return a && a.warn ? a.warn.apply(a, arguments) : Ta.log.apply(Ta, arguments)
    };
    /* General Utilities
     ----------------------------------------------------------------------------------------------------------------------*/
    var Za, $a, _a, ab = {}.hasOwnProperty,
        bb = /^\s*\d{4}-\d\d$/,
        cb = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
        db = b.fn,
    ...
    Ta.moment = function() {
        ...
        db.week = db.weeks = function(a) {
            var b = (this._locale || this._lang)._fullCalendar_weekCalc;
            return null == a && "function" == typeof b ? b(this) : "ISO" === b ? eb.isoWeek.apply(this, arguments) : eb.week.apply(this, arguments)
        },
        // Time-of-day
        // -------------------------------------------------------------------------------------------------
        // GETTER
        ...
        // -------------------------------------------------------------------------------------------------
        db.format = function() {
            return this._fullCalendar && arguments[0] ? na(this, arguments[0]) : this._ambigTime ? ma(this, "YYYY-MM-DD") : this._ambigZone ? ma(this, "YYYY-MM-DD[T]HH:mm:ss") : eb.format.apply(this, arguments)
        }, db.toISOString = function() {
        return this._ambigTime ? ma(this, "YYYY-MM-DD") : this._ambigZone ? ma(this, "YYYY-MM-DD[T]HH:mm:ss") : eb.toISOString.apply(this, arguments)
    },
        // Querying
        // -------------------------------------------------------------------------------------------------
        ...
        a.each(["isBefore", "isAfter"], function(a, b) {
            db[b] = function(a, c) {
                ...
                // only do custom logic if this is an enhanced moment
                // only do custom logic if this is an enhanced moment
                return this._fullCalendar ? (d = ja([this, a]), eb[b].call(d[0], d[1], c)) : eb[b].apply(this, arguments)
            }
        }), Za = "_d" in b() && "updateOffset" in b, $a = Za ? function(a, c) {
        a._d.setTime(Date.UTC.apply(Date, c)), b.updateOffset(a, !1)
    } : la, _a = Za ? function(a, c) {
    ...
    var ib = Ta.EmitterMixin = {
            ...
            loopCallbacks: function(a, b, c) {
                var d, e, f, g = a.split(".");
                for (d = 0; d < g.length; d++) e = g[d], e && (f = this.ensureCallbackObj((d ? "." : "") + e), f[b].apply(f, c))
            },
            ...
            var b = 0,
                c = {
                    ...
                    listenTo: function(b, c, d) {
                        if ("object" == typeof c) // given dictionary of callbacks
                            for (var e in c) c.hasOwnProperty(e) && this.listenTo(b, e, c[e]);
                        else "string" == typeof c && b.on(c + "." + this.getListenerNamespace(), // use event namespacing to identify this object
                            a.proxy(d, this))
                    },
                    /*
        ...
        mb = Ta.DragListener = va.extend(jb, {
            ...
            startInteraction: function(b, c) {
                ...
                this.isInteracting || (c = c || {}, this.delay = _(c.delay, this.options.delay, 0), this.minDistance = _(c.distance, this.options.distance, 0), this.subjectEl = this.options.subjectEl, this.isInteracting = !0, this.isTouch = d, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, this.originX = v(b), this.originY = w(b), this.scrollEl = m(a(b.target)), this.bindHandlers(), this.initAutoScroll(), this.handleInteractionStart(b), this.startDelay(b), this.minDistance || this.handleDistanceSurpassed(b))
            },
            handleInteractionStart: function(a) {
                this.trigger("interactionStart", a)
            },
            endInteraction: function(a) {
                this.isInteracting && (this.endDrag(a), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null), this.destroyAutoScroll(), this.unbindHandlers(), this.isInteracting = !1, this.handleInteractionEnd(a))
            },
                ...
                this.isTouch ? (this.listenTo(a(document), {
                    ...
                    touchstart: function(a) {
                        c ? // bindHandlers is called from within a touchstart,
                            c-- : b.endInteraction(a)
                    }
                }), this.scrollEl && this.listenTo(this.scrollEl, "scroll", this.handleTouchScroll)) : this.listenTo(a(document), {
            ...
            unbindHandlers: function() {
                this.stopListeningTo(a(document)), this.scrollEl && this.stopListeningTo(this.scrollEl)
            },
            // Drag (high-level)
            // -----------------------------------------------------------------------------------------------------------------
    ...
    mb.mixin({
        ...
        initAutoScroll: function() {
            var a = this.scrollEl;
            this.isAutoScroll = this.options.scroll && a && !a.is(window) && !a.is(document), this.isAutoScroll &&
        ...
        setScrollVel: function(a, b) {
            this.scrollTopVel = a, this.scrollLeftVel = b, this.constrainScrollVel(), // massages into realistic values
    ...
    var nb = mb.extend({
            ...
            handleInteractionStart: function(a) {
                ...
                this.computeCoords(), a ? (c = {
                    left: v(a),
                    top: w(a)
                }, d = c, e && (b = n(e), d = B(d, b)), this.origHit = this.queryHit(d.left, d.top), e && this.options.subjectCenter && (this.origHit && (b = A(this.origHit, b) || b), d = C(b)), this.coordAdjust = D(d, c)) : (this.origHit = null, this.coordAdjust = null),
            ...
            handleDragStart: function(a) {
                var b;
                mb.prototype.handleDragStart.apply(this, arguments), b = this.queryHit(v(a), w(a)), b && this.handleHitOver(b)
            },
            // Called when the drag moves
            handleDrag: function(a, b, c) {
                var d;
                mb.prototype.handleDrag.apply(this, arguments), d = this.queryHit(v(c), w(c)), ya(d, this.hit) || (this.hit && this.handleHitOut(), d && this.handleHitOver(d))
            },
        ...
        ob = va.extend(jb, {
            ...
            stop: function(b, c) {
                function d() {
                    this.isAnimating = !1, e.removeElement(), this.top0 = this.left0 = null, // reset state for future updatePosition calls
                    c && c()
                }
                var e = this,
            ...
            updatePosition: function() {
                ...
                null === this.top0 && (this.sourceEl.width(), a = this.sourceEl.offset(), b = this.el.offsetParent().offset(), this.top0 = a.top - b.top, this.left0 = a.left - b.left), this.el.css({
        ...
        pb = Ta.Grid = va.extend(jb, {
            ...
            processRangeOptions: function() {
                var a, b, c = this.view;
                this.eventTimeFormat = c.opt("eventTimeFormat") || c.opt("timeFormat") || // deprecated
            ...
            setElement: function(a) {
                this.el = a, y(a), this.view.calendar.isTouch ? this.bindDayHandler("touchstart", this.dayTouchStart) : this.bindDayHandler("mousedown", this.dayMousedown),
            ...
            dayMousedown: function(a) {
                this.clearDragListeners(), this.buildDayDragListener().startInteraction(a, {})
            },
                    ...
                    f = this.dayDragListener = new nb(this, {
                        ...
                        hitOver: function(d, f, h) {
                            h && ( // click needs to have started on a hit
                                ...
                                f || (a = null), e && (b = c.computeSelection(c.getHitSpan(h), c.getHitSpan(d)), b ? c.renderSelection(b) : b === !1 && g()))
                        },
                        hitOut: function() {
                            a = null, b = null, c.unrenderSelection(), h()
                        },
                        interactionEnd: function(e) {
                            a && d.triggerDayClick(c.getHitSpan(a), c.getHitEl(a), e), b &&
                            // the selection will already have been rendered. just report it
                            d.reportSelection(b, e), h(), c.dayDragListener = null
                        }
                    });
                return f
            },
    ...
    pb.mixin({
        ...
        renderEvents: function(a) {
            ...
            this.segs = [].concat( // record all segs
                this.renderBgEvents(c), this.renderFgEvents(d))
        },
        ...
        renderFgSegEls: function(b, c) {
            var d, e = this.view,
                f = "",
                g = [];
            if (b.length) { // don't build an empty html string
                ...
                a(f).each(function(c, d) {
                    ...
                    h && (h.data("fc-seg", f), // used by handlers
                        f.el = h, g.push(f))
                })
            }
            return g
        ...
        handleSegTouchStart: function(a, b) {
            ...
            f && h && (
                ...
                this.clearDragListeners(), c = g ? this.buildSegDragListener(a) : new mb, c._dragStart = function() {
                    f || d.selectEvent(e)
        ...
        handleSegMousedown: function(a, b) {
            ...
            !c && this.view.isEventDraggable(a.event) && (this.clearDragListeners(), this.buildSegDragListener(a).startInteraction(b, {
                distance: 5
            }))
        },
        ...
        startSegResize: function(b, c, d) {
            return a(c.target).is(".fc-resizer") ? (this.clearDragListeners(), this.buildSegResizeListener(b, a(c.target).is(".fc-start-resizer")).startInteraction(c, d), !0) : !1
        },
        /* Event Dragging
         ------------------------------------------------------------------------------------------------------------------*/
            ...
            var b, c, d, e = this,
                ...
                l = this.segDragListener = new nb(f, {
                    ...
                    dragStart: function(c) {
                        b = !0, e.handleSegMouseout(a, c), e.segDragStart(a, c), f.hideEvent(k)
                    },
        ...
        computeEventDrop: function(a, b, c) {
            ...
            return g.hasTime() === h.hasTime() ? (d = this.diffDates(h, g), c.allDay && R(d) ? (e = {
                start: c.start.clone(),
                end: f.getEventEnd(c),
                allDay: !1
        ...
        listenToExternalDrag: function(a, b, c) {
            var d, e = this,
                ...
                j = e.externalDragListener = new nb(this, {
                    ...
                    hitOver: function(a) {
                        d = e.computeExternalDrop(a.component.getHitSpan(a), // since we are querying the parent view, might not belong to this grid
                            i), d && !f.isExternalSpanAllowed(e.eventToSpan(d), d, i.eventProps) && (g(), d = null), d && e.renderDrag(d)
                    },
                    hitOut: function() {
                        d = null
                    },
                    ...
                    interactionEnd: function(b) {
                        ...
                        e.view.reportExternalDrop(i, d, a, b, c), e.isDraggingExternal = !1, e.externalDragListener = null
                    }
                });
            j.startDrag(b)
        },
        ...
        buildSegResizeListener: function(a, b) {
            var c, d, e = this,
                ...
                m = this.segResizeListener = new nb(this, {
                    ...
                    interactionEnd: function(b) {
                        c && e.segResizeStop(a, b), d && // valid date to resize to?
                        f.reportEventResize(k, d, this.largeUnit, j, b), e.segResizeListener = null
                    }
                });
            return m
        },
        ...
        computeEventResize: function(a, b, c, d) {
            ...
            return e = {
                ...
                allDay: d.allDay
            }, e.allDay && R(h) && (e.allDay = !1, g.normalizeEventTimes(e)), e[a].add(h), e.start.isBefore(e.end) || (f = this.minResizeDuration || (d.allDay ? g.defaultAllDayEventDuration : g.defaultTimedEventDuration), "start" == a ? e.start = e.end.clone().subtract(f) : e.end = e.start.clone().add(f)), e
        },
        ...
        eventsToSegs: function(b, c) {
            ...
            return a.each(e, function(a, b) {
                ...
                if (Ba(b[0]))
                    for (g = d.invertRanges(g), e = 0; e < g.length; e++) f.push.apply(f, // append to
                        d.eventRangeToSegs(g[e], b[0], c));
                else
                    for (e = 0; e < g.length; e++) f.push.apply(f, // append to
        ...
        eventRangeToSegs: function(a, b, c) {
            var d, e = this.eventRangeToSpans(a, b),
                f = [];
            for (d = 0; d < e.length; d++) f.push.apply(f, // append to
        ...
        invertRanges: function(a) {
            ...
            for (
                ...
                a.sort(Ea), b = 0; b < a.length; b++) c = a[b], c.start > h && g.push({
                start: h,
                end: c.start
            }), h = c.end;
        ...
        compareEventSegs: function(a, b) { // earlier events go first
            ...
            return a.eventStartMS - b.eventStartMS || b.eventDurationMS - a.eventDurationMS || b.event.allDay - a.event.allDay || F(a.event, b.event, this.view.eventOrderSpecs)
        }
    }), Ta.isBgEvent = Aa,
    ...
    var qb = Ta.DayTableMixin = {
            ...
            updateDayTable: function() {
                for (var a, b, c, d = this.view, e = this.start.clone(), f = -1, g = [], h = []; e.isBefore(this.end);) // loop each day from start to end
            ...
            renderHeadDateCellHtml: function(a, b, c) {
                var d = this.view;
                return '<th class="fc-day-header ' + d.widgetHeaderClass + " fc-" + Xa[a.day()] + '"' + (1 == this.rowCnt ? ' data-date="' + a.format("YYYY-MM-DD") + '"' : "") + (b > 1 ? ' colspan="' + b + '"' : "") + (c ? " " + c : "") + ">" + aa(a.format(this.colHeadFormat)) + "</th>"
            },
        ...
        rb = Ta.DayGrid = pb.extend(qb, {
            ...
            renderDates: function(a) {
                ...
                for (this.el.html(g), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), this.rowCoordCache = new lb({
                    els: this.rowEls,
                    isVertical: !0
            ...
            renderFill: function(b, c, d) {
                var e, f, g, h = []; // assignes `.el` to each seg. returns successfully rendered segs
    ...
    rb.mixin({
        ...
        // Retrieves all rendered segment objects currently rendered on the grid
        getEventSegs: function() {
            return pb.prototype.getEventSegs.call(this).concat(this.popoverSegs || [])
        },
        // Renders the given background event segments onto the grid
        ...
        renderSegRows: function(a) {
            var b, c, d = []; // group into nested arrays
            ...
            for (e = 0; n > e; e++) {
                ...
                if (f = m[e], g = 0, h = a("<tr/>"), p.push([]), q.push([]), r.push([]), f)
                    for (i = 0; i < f.length; i++) {
                        for ( // iterate through segments in level
                            j = f[i], d(j.leftCol),
                                ...
                                r[e][g] = k; g <= j.rightCol;) q[e][g] = k, p[e][g] = j, g++;
                        h.append(k)
                    }
                d(l), // finish off the row
                    this.bookendCells(h), o.append(h)
            }
            return { // a "rowStruct"
        ...
        rb.mixin({
            ...
            limitRow: function(b, c) {
                ...
                var e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t = this,
                    ...
                    v = [],
                    w = 0;
                if (c && c < u.segLevels.length) { // hide elements and get a simple DOM-nodes array
                    // iterate though segments in the last allowable level
                    for (e = u.segLevels[c - 1], f = u.cellMatrix, g = u.tbodyEl.children().slice(c).addClass("fc-limited").get(), h = 0; h < e.length; h++) {
                        for (i = e[h], d(i.leftCol), // process empty cells before the segment
                                 // determine *all* segments below `seg` that occupy the same columns
                                 l = [], k = 0; w <= i.rightCol;) j = this.getCellSegs(b, w, c), l.push(j), k += j.length, w++;
                        if (k) {
            ...
            renderMoreLink: function(b, c, d) {
                ...
                return a('<a class="fc-more"/>').text(this.getMoreLinkText(d.length)).on("click", function(g) {
                    ...
                    "function" == typeof h && (
                        ...
                        h = f.trigger("eventLimitClick", null, {
                            date: i,
                            dayEl: k,
                            moreEl: j,
                            segs: m,
                            hiddenSegs: n
                        }, g)), "popover" === h ? e.showSegPopover(b, c, j, m) : "string" == typeof h && // a view name
            ...
            showSegPopover: function(a, b, c, d) {
                ...
                }, this.isRTL ? f.right = i.offset().left + i.outerWidth() + 1 : f.left = i.offset().left - 1, this.segPopover = new kb(f), this.segPopover.show()
            },
            ...
            renderSegPopoverContent: function(b, c, d) {
                var e, f = this.view,
                    ...
                    i = a('<div class="fc-header ' + f.widgetHeaderClass + '"><span class="fc-close ' + (g ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + aa(h) + '</span><div class="fc-clear"/></div><div class="fc-body ' + f.widgetContentClass + '"><div class="fc-event-container"></div></div>'),
    ...
    var sb = Ta.TimeGrid = pb.extend(qb, {
        ...
        renderDates: function() {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new lb({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new lb({
                els: this.slatEls,
                isVertical: !0
        ...
        renderSlatRowHtml: function() {
            ...
            for (var a, c, d, e = this.view, f = this.isRTL, g = "", h = b.duration(+this.minTime); h < this.maxTime;) a = this.start.clone().time(h), c = fa(P(h, this.labelInterval)), d = '<td class="fc-axis fc-time ' + e.widgetContentClass + '" ' + e.axisStyleAttr() + ">" + (c ? "<span>" + aa(a.format(this.labelFormat)) + "</span>" : "") + "</td>", g += '<tr data-time="' + a.format("HH:mm:ss") + '"' + (c ? "" : ' class="fc-minor"') + ">" + (f ? "" : d) + '<td class="' + e.widgetContentClass + '"/>' + (f ? d : "") + "</tr>", h.add(this.slotDuration);
            return g
        },
        /* Options
         ------------------------------------------------------------------------------------------------------------------*/
        ...
        sliceRangeByTimes: function(a) {
            ...
            }, b = I(a, e), b && (b.dayIndex = c, f.push(b));
            return f
        },
        /* Coordinates
         ------------------------------------------------------------------------------------------------------------------*/
        ...
        renderNowIndicator: function(b) {
            ...
            f.push(a('<div class="fc-now-indicator fc-now-indicator-arrow"></div>').css("top", e).appendTo(this.el.find(".fc-content-skeleton"))[0]), this.nowIndicatorEls = a(f)
        },
        unrenderNowIndicator: function() {
    ...
    sb.mixin({
        ...
        fgSegHtml: function(a, b) {
             ...
             */
            return k.unshift("fc-time-grid-event", "fc-v-event"), f.isMultiDayEvent(g) ? (a.isStart || a.isEnd) && (c = this.getEventTimeText(a), d = this.getEventTimeText(a, "LT"), e = this.getEventTimeText(a, null, !1)) : (c = this.getEventTimeText(g), d = this.getEventTimeText(g, "LT"), e = this.getEventTimeText(g, null, !1)), '<a class="' + k.join(" ") + '"' + (g.url ? ' href="' + aa(g.url) + '"' : "") + (l ? ' style="' + l + '"' : "") + '><div class="fc-content">' + (c ? '<div class="fc-time" data-start="' + aa(e) + '" data-full="' + aa(d) + '"><span>' + aa(c) + "</span></div>" : "") + (g.title ? '<div class="fc-title">' + aa(g.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (j ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
        /* Seg Position Utils
         ------------------------------------------------------------------------------------------------------------------*/
        ...
        computeFgSegForwardBack: function(a, b, c) {
            ...
            if (void 0 === a.forwardCoord) // # of segments in the series
                ...
                for ( // not already computed
                    e.length ? (
                        ...
                        a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / ( // available width for series
                            b + 1), d = 0; d < e.length; d++) this.computeFgSegForwardBack(e[d], 0, a.forwardCoord)
        },
    ...
    var tb = Ta.View = va.extend(ib, jb, {
            ...
            constructor: function(a, c, d, e) {
                this.calendar = a, this.type = this.name = c, // .name is deprecated
            ...
            computeRange: function(a) {
                var b, c, d = M(this.intervalDuration),
                    e = a.clone().startOf(d),
            ...
            formatRange: function(a, b, c) {
                var d = a.end; // all-day?
                return d.hasTime() || (d = d.clone().subtract(1)), qa(a.start, d, b, c, this.opt("isRTL"))
            },
            /* Rendering
             ------------------------------------------------------------------------------------------------------------------*/
            ...
            display: function(b) {
                var c = this,
                    d = null;
                return this.displaying && (d = this.queryScroll()), this.calendar.freezeContentHeight(), this.clear().then(function() { // clear the content first (async)
            ...
            clear: function() {
                var b = this,
                    c = this.displaying;
                return c ? c.then(function() { // wait for the display to finish
            ...
            displayView: function(a) {
                this.isSkeletonRendered || (this.renderSkeleton(), this.isSkeletonRendered = !0), a && this.setDate(a), this.render && this.render(), this.renderDates(), this.updateSize(), this.renderBusinessHours(), // might need coordinates, so should go after updateSize()
            ...
            bindGlobalHandlers: function() {
                this.listenTo(a(document), "mousedown", this.handleDocumentMousedown), this.listenTo(a(document), "touchstart", this.handleDocumentTouchStart), this.listenTo(a(document), "touchend", this.handleDocumentTouchEnd)
            },
            ...
            startNowIndicator: function() {
                var a, c, d, e = this; // ms wait value
            ...
            isEventDraggable: function(a) {
                var b = a.source || {};
                return _(a.startEditable, b.startEditable, this.opt("eventStartEditable"), a.editable, b.editable, this.opt("editable"))
            },
            ...
            isEventResizable: function(a) {
                var b = a.source || {};
                return _(a.durationEditable, b.durationEditable, this.opt("eventDurationEditable"), a.editable, b.editable, this.opt("editable"))
            },
            ...
            triggerSelect: function(a, b) {
                this.trigger("select", null, this.calendar.applyTimezone(a.start), // convert to calendar's tz for external API
            ...
            handleDocumentMousedown: function(a) {
                ...
                !this.calendar.isTouch && u(a) && (this.processRangeUnselect(a), this.processEventUnselect(a))
            },
            ...
            triggerDayClick: function(a, b, c) {
                this.trigger("dayClick", b, this.calendar.applyTimezone(a.start), // convert to calendar's timezone for external API
                    c)
            },
            /* Date Utils
             ------------------------------------------------------------------------------------------------------------------*/
        ...
        vb = Ta.Calendar = va.extend({
            ...
            getUnitViewSpec: function(b) {
                var c, d, e;
                if (-1 != a.inArray(b, Ya))
                    for (c = this.header.getViewsWithButtons(), a.each(Ta.views, function(a) {
                        c.push(a)
                    }), d = 0; d < c.length; d++)
            ...
            buildViewSpec: function(a) {
                ...
                for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l;) d = Ua[l], e = h[l], l = null, "function" == typeof d && (d = {
                    "class": d
                }), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), e && (k.unshift(e), f = f || e.duration, l = l || e.type); // valid?
            ...
            buildViewSpecOptions: function(a) {
                a.options = c([ // lowest to highest priority
    ...
    vb.mixin(ib), vb.defaults = {
        ...
        longPressDelay: 1e3
    }, vb.englishDefaults = { // used by lang.js
        dayPopoverFormat: "dddd, MMMM D"
    }, vb.rtlDefaults = { // right-to-left defaults
    ...
    Ta.datepickerLang = function(b, c, d) {
        ...
        Ta.lang = function(b, d) {
            var e, f;
            e = wb[b] || (wb[b] = {}), d && (e = wb[b] = c([e, d])), f = Pa(b), a.each(yb, function(a, b) {
                null == e[a] && (e[a] = b(f, e))
            }), vb.defaults.lang = b
        };
    ...
    Ta.lang("en", vb.englishDefaults), Ta.sourceNormalizers = [], Ta.sourceFetchers = [];
    var Ab = {
            dataType: "json",
            cache: !1
        },
    ...
    var Cb = Ta.BasicView = tb.extend({
            ...
            initialize: function() {
                this.dayGrid = this.instantiateDayGrid(), this.scroller = new ub({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
            ...
            renderDates: function() {
                this.dayNumbersVisible = this.dayGrid.rowCnt > 1, // TODO: make grid responsible
                    this.weekNumbersVisible = this.opt("weekNumbers"), this.dayGrid.numbersVisible = this.dayNumbersVisible || this.weekNumbersVisible, this.el.addClass("fc-basic-view").html(this.renderSkeletonHtml()), this.renderHead(), this.scroller.render();
        ...
        Eb = Ta.MonthView = Cb.extend({
            ...
            computeRange: function(a) {
                var b, c = Cb.prototype.computeRange.call(this, a);
                // ensure 6 weeks
    ...
    var Fb = Ta.AgendaView = tb.extend({
            ...
            bottomRuleEl: null,
            initialize: function() {
                this.timeGrid = this.instantiateTimeGrid(), this.opt("allDaySlot") && ( // should we display the "all-day" area?
                    this.dayGrid = this.instantiateDayGrid()), this.scroller = new ub({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            ...
            renderDates: function() {
                ...
                this.el.find(".fc-body > tr > td").append(b), this.timeGrid.setElement(c), this.timeGrid.renderDates(),
        ...
        Gb = {
            // Generates the HTML that will go before the day-of week header cells
            renderHeadIntroHtml: function() {
                var a, b = this.view; // needed for matchCellWidths
