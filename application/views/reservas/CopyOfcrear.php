...
<script src="http://reservasfernandovi.esy.es/assets/jquery/jqueryGeneral/jquery-2.1.4.js"></script>
<script src="http://reservasfernandovi.esy.es/assets/jquery/jquery-ui-1.11.4.custom/jquery-ui.min.js"></script>
...
$(function () {
    ...
    $.datepicker.setDefaults($.datepicker.regional['es']); //Traduccion Espa�ol
...
<table id="tablaHoraria" border="1">
		<tr><td>Horas</td><td>Lunes</td><td>Martes</td><td>Mi�rcoles</td><td>Jueves</td><td>Viernes</td></tr>
