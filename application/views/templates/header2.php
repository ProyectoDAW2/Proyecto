...
<head>
    ...
    <?php }else{?>
    <link href='http://reservasfernandovi.esy.es/assets/css/bootstrap/bootstrap-330.css' rel='stylesheet'/>
    <link href='http://reservasfernandovi.esy.es/assets/css/usuario/registro2.css' rel='stylesheet' />
    <?php }?>
