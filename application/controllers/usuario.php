...
class Usuario extends CI_Controller
{
	...
	public function recuperarPost() {
		...
		if($existeCorreo!= "") {
			...
			$emailRes= $this->sendNewPass($correo, $message, "Recuperar Contraseï¿½a");
			if($emailRes){
	...
	public function contacto2(){
		...
		$message= $messageInicialRetocado."<br><br>Para poder contactar con este usuario y solucionar su consulta, le facilitamos su correo electrï¿½nico: ".$emailReceiver;
		$message= $messageInicialRetocado."<br><br>Para poder contactar con este usuario y solucionar su consulta, le facilitamos su correo electrï¿½nico: ".$emailReceiver;
	...
	public function sendMail($emailReceiver, $message, $subject) {
        ...
        if ($_SERVER ['SERVER_NAME'] == 'reservasfernandovi.esy.es') {
            $configGmail = array (
                    ...
                    'smtp_pass' => $adminPass, // contraseï¿½a del correo
                    'mailtype' => 'html',
                    'charset' => 'utf-8',
                    'newline' => "\r\n" 
            );
